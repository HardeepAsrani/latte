...
class latte_services_widget extends WP_Widget {
	...
	function form($instance) {
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e('Title', 'latte'); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id('icon'); ?>"><?php esc_html_e('Icon', 'latte'); ?></label>
			...
			<?php foreach($fontawesome as $item): ?>
				<option value="<?php echo $item; ?>" <?php if ($instance['icon'] == $item) echo 'selected="selected"'; ?>><?php echo esc_html($item); ?></option>
			<?php endforeach; ?>
			</select>
		...
		<p>
			<label for="<?php echo $this->get_field_id('link'); ?>"><?php esc_html_e('Link', 'latte'); ?></label> 
			<input class="widefat" id="<?php echo $this->get_field_id('link'); ?>" name="<?php echo $this->get_field_name('link'); ?>" type="url" value="<?php if( !empty($instance['link']) ): echo esc_url($instance['link']); endif; ?>" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('newwindow'); ?>"><?php esc_html_e('Open In New Window?', 'latte'); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id('text'); ?>"><?php esc_html_e('Text', 'latte'); ?></label> 
			<textarea class="widefat" id="<?php echo $this->get_field_id('text'); ?>" name="<?php echo $this->get_field_name('text'); ?>"><?php if( !empty($instance['text']) ): echo wp_kses_post( force_balance_tags( $instance['text'] ) ); endif; ?></textarea>
		</p>
		<?php 
	}
