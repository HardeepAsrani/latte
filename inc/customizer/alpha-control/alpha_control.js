...
Color.prototype.toString = function(remove_alpha) {
  ...
  $('.latte-color-control').each(function() {
	var $control = $(this),
	...
	$('<div class="latte-alpha-container"><div class="slider-alpha"></div><div class="transparency"></div></div>').appendTo($control.parents('.wp-picker-container'));
